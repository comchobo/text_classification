...
model1 = load_model('Project_model_Ens1_.h5',custom_objects={'SeqSelfAttention':SeqSelfAttention})
model2 = load_model('Project_model_Ens2_.h5',custom_objects={'SeqSelfAttention':SeqSelfAttention})
model3 = load_model('Project_model_Ens3_.h5',custom_objects={'SeqSelfAttention':SeqSelfAttention})
...
with open('wordIndexOkt_test5.json') as json_file:
    ...
    with session.as_default():
        with session.graph.as_default():
            ...
            for sentence in sentences:
                ...
                emotion = Model.out(output, model1, model2, model3, model4,
